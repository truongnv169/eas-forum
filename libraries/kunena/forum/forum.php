...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		self::$version_date = ('2017-05-26' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2017-05-26';
		self::$version_name = ('Ibis' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Ibis';
	}
}
